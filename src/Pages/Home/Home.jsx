...
<h1 className="lg:text-2xl md:text-xl animate__animated animate__zoomIn text-lg font-bold">Welcome to your gateway to exquisite properties and unparalleled hospitality! Let us guide <br></br> you through a world of Elegance. Your dream destination awaits, right here.</h1>
  ...
  {/* Why choose us section */}
    ...
    <p className="md:text-gray-700 font-bold">Fast & Easy Booking</p>
    <p className="text-gray-500 mt-4">Book your Property online or offline. Just call us on office time from anywhere. Let&apos;s begin your journey with us !</p>
    </div>
    </div>
    </card>

    <card className="md:border-indigo-400 md:border md:border-dashed md:hover:border-double md:rounded w-[30rem] lg:p-6 md:p-5">
    <div className="grid grid-cols-6 gap-3">
    ...
    <card className="md:border-indigo-400 md:border md:border-dashed md:hover:border-double md:rounded w-[30rem] lg:p-6 md:p-7">
    <div className="grid grid-cols-6 gap-3">
    <div className="col-span-2">
    <img src="https://cdn-icons-png.flaticon.com/128/2651/2651001.png" />
    </div>
    <div className="col-span-4">
    <p className="md:text-gray-700 font-bold">Statified Customers</p>
    <p className="text-gray-500 mt-4">WE HAVE 20,000+ HAPPY CUSTOMERS. View or review
  ...
  {/* Team Section */}
    ...
    <img src="https://mdbcdn.b-cdn.net/img/new/avatars/6.jpg" className="mx-auto rounded-full shadow-lg dark:shadow-black/20 w-[150px]" alt="Avatar" />
    </div>
    </div>
    <div className="p-6">
    <h5 className="mb-4 text-2xl font-bold">Marta Smith</h5>
    <p className="mb-6 text-base font-semibold">Assistant</p>
    ...
    <div className="flex justify-center">
    <div className="flex justify-center -mt-[75px]">
    <img src="https://mdbcdn.b-cdn.net/img/new/avatars/8.jpg" className="mx-auto rounded-full shadow-lg dark:shadow-black/20 w-[150px]" alt="Avatar" />
    </div>
    </div>
    <div className="p-6">
    <h5 className="mb-4 text-2xl font-bold">Darren Randolph</h5>
    <p className="mb-6 text-base font-semibold">Manager</p>
    <ul className="mx-auto flex list-inside justify-center">
    <a href="#!" className="px-2">
    {/* Facebook */}
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary dark:text-primary-400" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="flex justify-center">
    <div className="flex justify-center -mt-[75px]">
    <img src="https://mdbcdn.b-cdn.net/img/new/avatars/15.jpg" className="mx-auto rounded-full shadow-lg dark:shadow-black/20 w-[150px]" alt="Avatar" />
    </div>
    </div>
    <div className="p-6">
    <h5 className="mb-4 text-2xl font-bold">Ayat Black</h5>
    <p className="mb-6 text-base font-semibold">Technician</p>
    <ul className="mx-auto flex list-inside justify-center">
    <a href="#!" className="px-2">
    {/* Dribbble */}
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 text-primary dark:text-primary-400">
